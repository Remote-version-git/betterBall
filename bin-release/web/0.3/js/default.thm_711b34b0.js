	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["status_bar","is_trumpet","trumpet_check","score","avatar","nickname","bg","make_area","player_area","game_scene","explain_panel"];
	...
	_proto.game_scene_i = function () {
		...
		t.width = 640;
		t.elementsContent = [this.make_area_i(),this.player_area_i()];
		return t;
	};
	_proto.make_area_i = function () {
		var t = new eui.Group();
		this.make_area = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
	...
	function ReportCardSkin() {
		_super.call(this);
		this.skinParts = ["go_back","nickname","score"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this._Group6_i()];
	}
	...
	_proto._Group6_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Group1_i(),this._Group4_i(),this._Group5_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.x = 480;
		t.y = 52;
		t.elementsContent = [this._Rect1_i(),this.go_back_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	_proto._Group4_i = function () {
		...
		t.width = 500;
		t.y = 250;
		t.elementsContent = [this._Image5_i(),this._Group2_i(),this._Group3_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.x = 130;
		t.y = 40;
		t.elementsContent = [this.nickname_i(),this.score_i()];
		return t;
	};
	_proto.nickname_i = function () {
		var t = new eui.Label();
	...
	_proto._Label3_i = function () {
		...
		t.left = 0;
		t.size = 24;
		t.text = "2020“创青春 交子杯”新网银行金融科技挑战赛";
		t.textAlign = "left";
		t.textColor = 0xc8aef7;
		t.top = 0;
		t.percentWidth = 100;
	...
	function ScoreGameViewSkin() {
		_super.call(this);
		this.skinParts = ["trophy_img","score","showRankingList","report_card_btn","restart_button"];
	...
	_proto._Group5_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.trophy_img_i(),this.score_i(),this._Label1_i(),this._Group4_i()];
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.top = 0;
		t.width = 180;
		t.elementsContent = [this.showRankingList_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.width = 180;
		t.y = 110;
		t.elementsContent = [this.report_card_btn_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.scaleY = 1;
		t.width = 180;
		t.elementsContent = [this.restart_button_i()];
		return t;
	};
	...
	function StartGameViewSkin() {
		_super.call(this);
		this.skinParts = ["start_bg","xw_logo","pig_bg_img","batman_bg_img","ranking_button","is_trumpet","trumpet_check","rules_button","start_button","start_group"];
	...
	_proto.start_group_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.xw_logo_i(),this._Group1_i(),this.ranking_button_i(),this.trumpet_check_i(),this._Group2_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.width = 500;
		t.y = 920;
		t.elementsContent = [this.rules_button_i(),this.start_button_i()];
		return t;
	};
