	...
	_proto._Group3_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.status_bar_i(),this.trumpet_check_i(),this._Group1_i(),this._Group2_i(),this.tip_i(),this.avatar_i(),this.nickname_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.x = 285.273;
		t.elementsContent = [this.passScore_i(),this._Label2_i()];
		return t;
	};
