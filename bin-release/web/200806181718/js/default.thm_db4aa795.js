	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["status_bar","is_trumpet","trumpet_check","score","passScore","tip","avatar","nickname","bg","player_area","game_scene","explain_panel"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Group2_i(),this.bg_i(),this.game_scene_i(),this.explain_panel_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.status_bar_i(),this.trumpet_check_i(),this._Group1_i(),this.passScore_i(),this._Label2_i(),this.tip_i(),this.avatar_i(),this.nickname_i()];
		return t;
	};
	...
	function ReportCardSkin() {
		...
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this._Group6_i()];
	}
	...
	_proto._Group6_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.go_back_i(),this._Group4_i(),this._Group5_i()];
		return t;
	};
	...
	_proto._Label2_i = function () {
		var t = new eui.Label();
		t.anchorOffsetX = -1.641;
		t.anchorOffsetY = -3.281;
		t.left = 0;
		t.size = 24;
		t.text = "姓       名:";
		t.textAlign = "center";
	...
	_proto._Image2_i = function () {
		...
		t.anchorOffsetY = 0;
		t.height = 125.729;
		t.source = "ui_json.txt_friend_png";
		t.width = 323.304;
		t.x = -42.25;
		t.y = 27.72;
		return t;
	...
	_proto._Image3_i = function () {
		...
		t.anchorOffsetY = 0;
		t.height = 192.954;
		t.source = "ui_json.txt_batman_png";
		t.width = 298.342;
		t.x = 215.48;
		t.y = 20;
		return t;
	...
	function StartGameViewSkin() {
		_super.call(this);
		this.skinParts = ["start_bg","pig_bg_img","batman_bg_img","start_button","ranking_button","is_trumpet","trumpet_check","start_group"];
	...
	_proto.start_group_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Group1_i(),this.ranking_button_i(),this.trumpet_check_i()];
		return t;
	};
	_proto._Group1_i = function () {
		var t = new eui.Group();
		...
		t.elementsContent = [this.pig_bg_img_i(),this.batman_bg_img_i(),this._Image1_i(),this._Image2_i(),this.start_button_i()];
		return t;
	};
	...
	_proto.start_button_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.verticalCenter = 357.5;
		t.width = 196.2;
		t.x = 201.9999999999999;
