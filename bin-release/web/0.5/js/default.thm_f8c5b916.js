	...
	_proto._Group5_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image2_i(),this._Image3_i(),this._Image4_i(),this.go_back_i(),this._Group3_i(),this._Group4_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto._Group3_i = function () {
		...
		t.width = 500;
		t.y = 250;
		t.elementsContent = [this._Image5_i(),this._Group1_i(),this._Group2_i()];
		return t;
	};
